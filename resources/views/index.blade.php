 ...
 <form id="article-form" method="POST" action="/submit-article" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="icon-input">
                ...
                <input type="text" id="title" name="title" class="icon-padding" placeholder="A captivating title for your article" required>
            </div>
        </div>

        <div class="form-group">
            <label class="required" for="abstract">Brief Summary</label>
            <textarea id="abstract" name="abstract" rows="3" placeholder="Write a compelling summary to attract readers" required></textarea>
        ...
        <div class="form-group">
            ...
            <div class="tag-input-wrapper">
                <div class="icon-input" style="flex-grow: 1;">
                    ...
                    <input type="text" id="tag-input" class="icon-padding" placeholder="Add relevant tags (press Enter after each tag)">
                </div>
    ...
    <div class="form-card">
        ...
        <div class="form-group">
            ...
            <div class="icon-input">
                ...
                <input type="text" id="name" name="name" class="icon-padding" placeholder="Your full name as you want it to appear" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="icon-input">
                ...
                <input type="email" id="email" name="email" class="icon-padding" placeholder="Your contact email (not publicly displayed)" required>
            </div>
        </div>
    </div>
    ...
    .then(data => {
      if (data.success) {
        ...
        if (successMsg) {
          ...
          successMsg.textContent = data.message || 'Article submitted successfully!';
        } else {
        ...
        setTimeout(function() {
          ...
          const fileNameDisplay = document.getElementById('file-name');
          if (fileNameDisplay) {
            fileNameDisplay.textContent = 'No files selected';  // Reset file display
          }
